...
public class Ej11 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet resultado = sentencia.executeQuery("Select count(distinct(numde)), sum(salar) FROM empleados, departamentos WHERE departamentos.numde = empleados.numde GROUP BY nomde;");
